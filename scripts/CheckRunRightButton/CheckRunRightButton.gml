function CheckRunRightButton(argument0, argument1) {
	...
	if (playerControl == 1) {
	    if (keyboard_check(ord("D")) || gamepad_button_check(1, gp_padr) ||
	...
	if (playerControl == 2) {
	    if (gamepad_button_check(2, gp_padr) ||
	...
	if (playerControl == 3) {
	    if (gamepad_button_check(3, gp_padr) ||
