	...
	switch (item) {
        case 1:
            if (ammo > 0) {
                ...
                var inst = instance_create(x + (5 * faceDir), y - 21, objWeaponLaserCharge);
                inst.alarm[0] = 28;
                inst.image_xscale = faceDir;
        ...
        case 2:
            if (ammo > 0 && collision_line(x + (5 * faceDir), y, x + (5 * faceDir), y + 5, objFloor, false, true)) {
                ammo -= 1;
        ...
        case 8:
            if (ammo > 0 && collision_line(x + (10 * faceDir), y, x + (10 * faceDir), y + 5, objFloor, false, true)) {
                ammo -= 1;
                sprite_index = sprRobotCrouch;
                alarm[0] = 80;
                alarm[1] = 1;
